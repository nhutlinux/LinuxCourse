...
/* SSD1306 device name */
#define SSD1306_DEV_COMPATIBLE "devlinux,ssd1306spi"
#define SSD1306_DEV_NAME "ssd1306spi"
#define SSD1306_DEV_CLASS "ssd1306-class"
#define SSD1306_DRIVER_NAME "ssd1306_spi_driver"

/* SSD1306 Display Specs */
#define SSD1306_MAX_SEG     128
#define SSD1306_MAX_LINE    8
...
typedef struct ssd1306_spi_module {
    ...
    char *kmalloc_ptr;
} ssd1306_spi_module_t;

extern char message[SSD1306_MAX_BUFF]; /* Message buffer for display */
extern ssd1306_spi_module_t* ssd1306Module; /* SSD1306 module instance */
